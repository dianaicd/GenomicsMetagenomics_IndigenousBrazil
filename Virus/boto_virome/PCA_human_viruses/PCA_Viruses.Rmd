...
Using the raw counts. Without scaling (scale deffault in heatmap is "row"): rows are not centered (substraction of the row means) and scaled (divide centered rows by standar deviation)
```{r}
heatmap(raw_hits,
        col = rev(heat.colors(350)),
        scale = "none",
