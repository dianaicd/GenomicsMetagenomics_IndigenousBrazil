...
for (s in selected_samples) {
  ...
  pdf(paste0("~/axiom_virome/Boto_virome/true_complete/virus_mappings/parvovirus/single_fasta/output_mystats/all_samples/damageplots/selected_samples/damageplots_", s, "_mapQ", q, ".pdf"), width = 14, height = 12)
  layout(matrix(seq(nCol*nRow), ncol = nCol, byrow = T))
